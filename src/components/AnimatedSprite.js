...
class AnimatedSprite extends React.Component {
  ...
  componentDidMount () {
    ...
    if (this.props.tweenStart === 'fromMount' && this.props.tweenOptions !== null) {
      ...
      console.log('loopAnimation', this.props.loopAnimation)
  ...
  shouldComponentUpdate (nextProps, nextState) {
    ...
    if (nextProps.loopAnimation !== this.props.loopAnimation) {
      console.log('loopAnimation', nextProps.loopAnimation)
      this.startAnimation();
      return true;
    } else {
